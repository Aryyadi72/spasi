          ...
          <div class="navbar-nav flex-row order-md-last">
                    ...
                    <div class="list-group list-group-flush list-group-hoverable">
                      <div class="list-group-item">
                        <div class="row align-items-center">
                          ...
                          <div class="col text-truncate">
                            <a href="#" class="text-body d-block">Transaksi Masuk</a>
                      ...
                      <div class="list-group-item">
                        <div class="row align-items-center">
                          ...
                          <div class="col text-truncate">
                            <a href="#" class="text-body d-block">Transaksi Keluar</a>
                            <div class="d-block text-muted text-truncate mt-n1">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url(<?= base_url() ?>assets/upload/pelanggan/<?= $username['foto'] ?>)"></span>
            ...
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="<?= base_url('dashboard_pelanggan')?>" >
                ...
                <!-- Produk -->
                <li class="nav-item ">
                  <a class="nav-link" href="<?= base_url('produk_pelanggan')?>" >
                ...
                <!-- Profile -->
                <li class="nav-item ">
                  <a class="nav-link" href="<?= base_url('profil_pelanggan')?>" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <div style="margin-left:750px;padding-top:5px;" class="my-2 my-md-0 flex-grow-1 flex-md-grow-0 order-first order-md-last">
