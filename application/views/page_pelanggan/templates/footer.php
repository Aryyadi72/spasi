<footer class="footer footer-transparent d-print-none">
    ...
    <script src="<?= base_url()?>./assets/dist/libs/jsvectormap/dist/maps/world.js?1674944402" defer></script>
    <script src="<?= base_url()?>./assets/dist/libs/jsvectormap/dist/maps/world-merc.js?1674944402" defer></script>
    <!-- Tabler Core -->
    ...
    <script src="<?= base_url()?>./assets/dist/js/demo.min.js?1674944402" defer></script>
	 <!-- Libs JS -->
    <script src="<?= base_url()?>./assets/dist/libs/list.js/dist/list.min.js?1674944402" defer></script>
    <!-- Tabler Core -->
    <script>
      // @formatter:off
