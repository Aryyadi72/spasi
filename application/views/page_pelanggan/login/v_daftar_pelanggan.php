  ...
  <body  class=" d-flex flex-column">
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
        ...
        <form class="card card-md" action="<?= base_url() ?>assets/" method="get" autocomplete="off" novalidate>
          <div class="card-body">
        ...
        <div class="text-center text-muted mt-3">
          Already have account? <a href="<?= base_url('pelanggan/login_pelanggan') ?>" tabindex="-1">Sign in</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
