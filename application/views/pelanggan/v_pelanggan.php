<div class="page-wrapper">
                    ...
                    <tbody class="table-tbody">
                      <tr>
                        ...
                        <td>
                          ...
                          <div class="col-6 col-sm-4 col-md-2 col-xl-auto">
                            <a href="<?= base_url('pelanggan/deletePelanggan/'. $p->id_pelanggan) ?>" class="btn btn-red w-100 btn-icon">
      ...
      const list = new List('table-default', {
      	...
      	valueNames: [ 'sort-no', 'sort-name', 'sort-type', 'sort-city', 'sort-score', 'sort-username',
